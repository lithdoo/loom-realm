...
6. [Docs Freeze / Agent execution ledger](./doc/30-implementation/viewport-core-freeze-ledger.md)：唯一实时 status、最终文档 SHA、审查/签署、精确文件范围、实施顺序与测试证据。冲突时按正式文档主题 owner 解决，不由 mutable HEAD 或历史草案判断。
