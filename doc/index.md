...
15. [M14 Qualification Record](./30-implementation/m14-qualification.md)
16. [ADR 0031：M13 Web Presentation](./decisions/0031-business-owned-web-component-projection.md)
17. [ADR 0032：Framework / Game Library / Example Boundary](./decisions/0032-game-library-example-boundary.md)
18. [ADR 0033：Electron-hosted Hostra Runner](./decisions/0033-electron-hostra-run-as-node.md)
