...
Coverage audit 强制验证 normative catalog 唯一性、group 全覆盖、fixture 注册/执行/通过集合相等、每条 fixture claimed role 非空，且 M11 不产生 transport evidence。
...
@loomrealm/renderer
    ...
    same-generation identity history across carrier replacement
