...
> 层级：模块设计  
> 状态：M8 Data / M10 Input / M11 Render / M12 ResourceClient / M13 Web Presentation **historical Implemented + Qualified**；revised four-child `/1` / Viewport **Not Implemented / Core Docs Frozen 2026-09-17（subject `4cbf620`）**  
