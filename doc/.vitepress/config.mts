    ...
    nav: [
      ...
      { text: '阅读指南', link: '/README' },
      {
        ...
        items: [
          ...
          { text: 'Main ⇄ Subsystem Control v1', link: '/15-contracts/subsystem-control-lifecycle-protocol' },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Main ⇄ Subsystem Control / Runtime Lifecycle v1', link: '/15-contracts/subsystem-control-lifecycle-protocol' },
          { text: 'Frame 生命周期与调用协议草案', link: '/15-contracts/system-lifecycle-protocol' },
