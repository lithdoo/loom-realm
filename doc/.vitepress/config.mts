    ...
    nav: [
      ...
      { text: '阅读指南', link: '/README' },
      {
        ...
        items: [
          ...
          { text: 'Subsystem Control Protocol v2', link: '/15-contracts/subsystem-control-protocol-v2' },
          { text: 'Runtime Control Application Profile v2', link: '/15-contracts/runtime-control-profile-v2' },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Subsystem Control Protocol v2 · Current', link: '/15-contracts/subsystem-control-protocol-v2' },
          { text: 'Runtime Control Application Profile v2 · Current', link: '/15-contracts/runtime-control-profile-v2' },
          { text: 'Frame / Call Protocol v1 · Frozen', link: '/15-contracts/frame-call-protocol-v1' },
          { text: 'Frame / Call v1 Conformance Profile', link: '/15-contracts/frame-call-conformance-v1' },
          ...
          { text: 'Legacy · Subsystem Control v1 · Abandoned', link: '/15-contracts/subsystem-control-lifecycle-protocol' },
          { text: 'Legacy · Runtime Control Profile v1 · Abandoned', link: '/15-contracts/runtime-control-profile-v1' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'ADR 0009 · Historical Control v1 Freeze', link: '/decisions/0009-freeze-subsystem-control-protocol-v1' },
          ...
          { text: 'ADR 0015 · Frame / Call Batch F / v1 Completion', link: '/decisions/0015-freeze-frame-call-protocol-v1-batch-f' },
          { text: 'ADR 0016 · 协议边界清理', link: '/decisions/0016-protocol-boundary-cleanup' },
          { text: 'ADR 0017 · Abandon Control v1 / Promote v2', link: '/decisions/0017-abandon-subsystem-control-v1' },
        ],
      },
      {
        text: '过渡资料',
