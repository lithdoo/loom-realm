...
> 状态：**旧三-child `/1` Package-local Core Baseline Implemented / M8 Role Integration Qualified（历史 subject）；修订后四-child `/1` / Viewport Docs Frozen 2026-09-17（subject `4cbf620`）/ Not Implemented**  
